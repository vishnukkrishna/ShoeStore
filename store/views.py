...
def list_category(request, category_slug=None):
    ...
    return render(
        request,
        "store/list_category.html",
        {"category": category, "products": paged_products},
    )
...
def list_brand(request, brand_slug=None):
    ...
    return render(
        request, "store/list_brand.html", {"brand": brand, "products": paged_products}
    )
        ...
        if request.user.is_authenticated:
            try:
                ...
                in_wishlist = WishlistItem.objects.filter(
                    wishlist=wishlist, product__title=product
                )
